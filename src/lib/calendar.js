...
export default class Calendar {
   ...
   * 天干地支之天干速查表
   */
  static Gan = '甲乙丙丁戊己庚辛壬癸';

  /**
   * 天干地支之地支速查表
   */
  static Zhi = '子丑寅卯辰巳午未申酉戌亥';

  /**
   * 天干地支之地支速查表<=>生肖
   */
  static Animals = '鼠牛虎兔龙蛇马羊猴鸡狗猪';
   ...
   * 月份转农历称呼速查表
   */
  static nStr3 = ['正', '二', '三', '四', '五', '六', '七', '八', '九', '十', '冬', '腊'];
